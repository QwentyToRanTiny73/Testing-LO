...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description:
      'Проведите вино через весь цикл — от выбора срока сбора до розлива — принимая решения на каждом этапе. Каждый выбор меняет аромат, структуру, стабильность и чистоту вина; в конце вы получаете дегустационную оценку и разбор последствий. Пять сценариев: ароматическое белое (Мускат), сухое розе (Каберне + Саперави), оранж (Мускат + Кокур), красное для выдержки (Каберне) и параллельная кампания на арендной винодельне (custom-crush) с розливом под чужой лицензией.',
    icon: '🎮',
    level: 'Тренажёр',
    durationLabel: '5 сценариев · 10–16 этапов решений каждый',
    audience: [
    ...
    format: [
      { icon: '🍇', label: 'Сценарии', desc: 'Белое, розе, оранж, красное и кампания custom-crush' },
    ...
    href: 'simulator',
    stats: [
      { label: 'сценариев', value: '5' },
      { label: 'этапов решений', value: '59' },
      { label: 'вариантов выбора', value: '170+' },
    ],
  },
];
