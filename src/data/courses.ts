...
export const courses: Course[] = [
  {
    ...
    icon: '🍷',
    level: 'Практический',
    durationLabel: '16 модулей · практика на каждом этапе',
    audience: [
    ...
    format: [
      ...
      { icon: '🧮', label: 'Калькуляторы', desc: '7 практических инструментов для расчётов' },
  ...
  },
  {
    ...
    description:
      'Проведите вино через весь цикл — от выбора срока сбора до розлива — принимая решения на каждом этапе. Каждый выбор меняет аромат, структуру, стабильность и чистоту вина; в конце вы получаете дегустационную оценку и разбор последствий. Шесть сценариев: ароматическое белое (Мускат), сухое розе (Каберне + Саперави), оранж (Мускат + Кокур), красное для выдержки (Каберне), кампания на арендной винодельне (custom-crush) и полный сезон 2026 по технологической методичке — четыре партии от подготовки подвала до отгрузки, со справочником препаратов Martin Vialatte / Sofralab.',
    icon: '🎮',
    level: 'Тренажёр',
    durationLabel: '6 сценариев · 10–19 этапов решений каждый',
    audience: [
    ...
    format: [
      { icon: '🍇', label: 'Сценарии', desc: 'Белое, розе, оранж, красное, custom-crush и сезон 2026 по методичке' },
    ...
    href: 'simulator',
    stats: [
      { label: 'сценариев', value: '6' },
      { label: 'этапов решений', value: '78' },
      { label: 'вариантов выбора', value: '230+' },
    ],
  },
];
