...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description:
      'Проведите вино через весь цикл — от выбора срока сбора до розлива — принимая решения на каждом этапе. Каждый выбор меняет аромат, структуру, стабильность и чистоту вина; в конце вы получаете дегустационную оценку и разбор последствий. Четыре сценария: ароматическое белое (Мускат), сухое розе (Каберне + Саперави), оранж (Мускат + Кокур) и красное для выдержки (Каберне).',
    icon: '🎮',
    level: 'Тренажёр',
    durationLabel: '4 сценария · 10–12 этапов решений каждый',
    audience: [
    ...
    href: 'simulator',
    stats: [
      { label: 'сценария', value: '4' },
      { label: 'этапов решений', value: '43' },
      { label: 'вариантов выбора', value: '120+' },
    ],
  },
];
