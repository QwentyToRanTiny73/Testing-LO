...
export interface Module {
  ...
  course: string;
  /** Стадия производственной цепочки (см. process.ts). Только для практикума. */
  stage?: string;
}
...
export const modules: Module[] = [
  ...
  },
  {
    ...
    description: 'Тартратная стабилизация (холод, КМЦ, метавинная кислота), белковая и коллоидная стабилизация.',
    icon: '❄️',
    order: 12,
    course: COURSE_PRAKTIKUM,
    stage: 'obrabotki',
